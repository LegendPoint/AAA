  ...
  <main>
    <div class="container">
      ...
      <div>
        ...
        <div class="form-group-row">
          <label for="name" class="col-sm-2 col-form-label">First Name:<span class="required-label">*</span></label>
          <div class="col-sm-10">
        ...
        <div class="form-group-row">
          <label for="telephone" class="col-sm-2 col-form-label">Last Name:<span class="required-label">*</span></label>
          <div class="col-sm-10">
